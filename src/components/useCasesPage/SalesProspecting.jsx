...
const SalesProspecting = () => {
  const highlightItems = [
    {
      title: "Give Sales Teams Confidence",
      gradient: "linear-gradient(90deg, #F4FFE8 0%, #EFF6FF 100%)",
    },
    {
      title: "Minimize Bounce Rates",
      gradient: "linear-gradient(90deg, #F9EEFF 0%, #EBF3FF 100%)",
    },
    {
      title: "Accurate & Deliverable Emails",
      gradient: "linear-gradient(90deg, #FFFBEA 0%, #EFF7FF 100%)",
    },
    {
      title: "Boost Your Response Rates",
      gradient: "linear-gradient(90deg, #EEF6FF 0%, #E9EDFF 100%)",
    },
  ];
