          ...
          >
            ...
            <div className="flex flex-col lg:flex-row items-start gap-8 md:gap-10 lg:gap-12 xl:gap-30 lg:items-stretch">
              ...
              <div className="w-full lg:w-auto lg:flex-1 flex flex-col lg:mt-20 lg:justify-center">
                {/* Heading */}
                <h1
                  className="font-['Inter'] flex flex-col gap-3 font-bold text-[#132436] leading-[52.8px] tracking-[-2.4px] capitalize mb-[46.5px] sm:mb-[46.5px]"
                  style={{
                ...
                {/* Description */}
                <p
                  className="font-['Manrope'] max-w-[435.75px] font-semibold text-[#63778B] mb-[45px] xl:mb-[60px]"
                  style={{
                ...
                <div className="flex flex-wrap items-center gap-[15px] mb-[25.5px] sm:mb-[46.5px]">
                  ...
                  <button
                    className="text-[#3A4A5A] font-['Manrope'] px-[18px] py-[12px] font-semibold flex items-center gap-[7.5px] hover:text-[#EB3609] transition-colors"
                    style={{
                      fontSize: "18px",
                      lineHeight: "22.5px",
                      letterSpacing: "0px",
                ...
                <div className="flex flex-wrap items-center gap-[10px]">
                  <div
                    className="rounded-[50px] bg-[#FCFCFD] border border-[#EEF0F3] flex items-center gap-[7.5px] px-[12px] py-[9px]"
                    style={{ height: "41px" }}
                  >
                    <span className="inline-flex items-center justify-center w-[17.25px] h-[17.25px]">
                      <img
