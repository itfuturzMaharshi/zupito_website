...
const Footer = () => {
  return (
    <section className="relative w-full overflow-hidden bg-transparent">
      {/* Background box with full width */}
      <div className="w-full flex justify-center px-6! py-6! sm:py-6! md:py-6!">
        <div
          ...
          style={{
            backgroundImage: "url('/images/footer-background-img.png')",
            opacity: 1,
          }}
        >
          {/* Decorative vector image (top-right) */}
          <img
            src="/images/home-footer-vector.png"
            alt=""
            className="pointer-events-none select-none absolute right-36 top-45 w-[120px] z-[1] sm:w-[160px] md:w-[220px] lg:w-[260px]"
          />
          {/* Animated image (bottom, responsive) */}
          <div
            className="absolute pointer-events-none z-[1] bottom-242! left-28! -translate-x-1/2 w-40 h-40 sm:left-6 sm:bottom-6 sm:translate-x-0 md:w-52 md:h-52 lg:w-60 lg:h-60"
          >
            <img
          ...
          <img
            ...
            style={{ left: 1270, bottom: 930 }}
          />
          {/* Headline and CTA area */}
          <div className="relative z-2 w-full max-w-full mx-auto flex flex-col items-center gap-[20px] md:gap-[24px]">
              {/* Headline */}
              <h2 className="font-bold text-center tracking-[-2.4px] mt-8! text-white leading-[40px] text-[28px] sm:text-[36px] sm:leading-[48px] md:text-[46px] md:leading-[62px] lg:text-[54px] lg:leading-[72px] xl:text-[60px] xl:leading-[80px] capitalize">
                ...
                {[
                  ...
                  >
                    <div className="w-12 h-12 rounded-full  flex items-center justify-center">
                      <img src={s.icon} alt={s.label} className="w-12 h-12 object-contain" />
                    </div>
            ...
            {/* Copyright */}
            <div className="w-full max-w-full mx-auto text-center text-white text-[14px] sm:text-[16px] md:text-[20px] pt-12!">
              © 2025 Zupitu. <span className="text-white/70">All Rights Reserved.</span>
            </div>
        </div>
