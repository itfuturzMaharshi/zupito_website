  ...
  return (
    <main className="relative w-full bg-white">
      ...
      <section className="relative w-full overflow-hidden">
        ...
        <div className="w-full px-6! sm:px-8! md:px-12! lg:px-16! xl:px-24! 2xl:px-[264px]! py-10! lg:py-16! xl:py-20!">
          <div className="max-w-[full] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 lg:gap-10 xl:gap-16 items-center">
            {/* Copy */}
            <div className="order-2 lg:order-1">
              <h1 className="text-[#132436] font-bold tracking-[-0.02em] leading-[1.08] space-y-1 mt-6! sm:mt-8! md:mt-10!">
              ...
              <p className="text-[#63778B] max-w-[full] sm:max-w-[640px] md:max-w-[720px] font-semibold text-[16px] leading-[28px] sm:text-[18px] sm:leading-[32px] md:text-[20px] md:leading-[34px] lg:text-[20px] lg:leading-[34px] mt-5! sm:mt-6!">
              ...
              <div className="mt-10! sm:mt-12! md:mt-14! lg:mt-16! mb-4 w-full max-w-[565px] h-px bg-linear-to-l from-transparent to-[#666666]/20" />
